...
print(p)
ggsave(paste0(graph_dir, "size_percentile.png"), plot = p, width = 7, height = 4, dpi = 300)
...
# Print the plot
print(p)
ggsave(paste0(graph_dir, "density_size_percentile.png"), plot = p, width = 7, height = 4, dpi = 300)
...
# Print the plot
print(p)
ggsave(paste0(graph_dir, "area_size_percentile.png"), plot = p, width = 7, height = 4, dpi = 300)
