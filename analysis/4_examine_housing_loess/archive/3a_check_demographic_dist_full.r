...
print(p)
ggsave(paste0(graph_dir, "size_percentile_mort_full.png"), plot = p, width = 7, height = 4, dpi = 300)
...
# Print the plot
print(p)
ggsave(paste0(graph_dir, "income_size_percentile_full.png"), plot = p, width = 7, height = 4, dpi = 300)
...
# Print the plot
print(p)
ggsave(paste0(graph_dir, "mortgage_ratio_size_percentile_full.png"), plot = p, width = 7, height = 4, dpi = 300)
